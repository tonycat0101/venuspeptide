...
function generarVialDinamico(prod) {
  ...
  // Si tiene imagen real, mostrarla grande
  if (prod.imagen) {
    return `
      <div style="width: 100%; display: flex; align-items: center; justify-content: center; padding: 8px 0;">
        <img src="${prod.imagen}" alt="${prod.nombre}" style="width: 100%; max-height: 240px; object-fit: contain; display: block; border-radius: 6px;">
      </div>
    `;
  }

  // Vial mockup cuando no hay imagen
  return `
    <div class="vial-mockup-dinamico" style="background-image: url('img/vial-vacio.png');">
      <div class="vial-label">
